...
class PresenterImplementation(PresenterInterface):
    ...
    def get_total_reactions_count_response(
        self, reactions_count_dict: Dict[str, int]) ->Dict[str, int]:
    ...
    def get_response_for_get_post_reactions(self,
    ...
    def _convert_comment_to_dict(self, reply, user_dto_dict):
        comment_details = {
            ...
            "commenter": self._get_user_details(user_dto_dict[reply.user),
    ...
    def _get_user_dtos_dict(post_details_dto):
        ...
        for user in post_details_dto.users_dto:
            ...
            users_dto_dict[user_id] = user_id
