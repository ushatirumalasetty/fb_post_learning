...
class TestCase01GetPostsWithMorePositiveReactionsAPITestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username, password):
        ...
        PostReactionsFactory.create_batch(2, reaction_type="WOW")
        PostReactionsFactory.create_batch(3, reaction_type="SAD")
